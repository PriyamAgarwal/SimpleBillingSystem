  ...
  extends JFrame
{
  ...
  try {
    String sql = "select  cust_name,cust_phone,address,grand_total from cyber_customers where invoice_no='" + ino + "'";
  ...
  try {
    ...
    doc.insertString(doc.getLength(), "Customer:",null);
    ...
    doc.insertString(doc.getLength(), "__________________________________________________________________________\n", null);
      ...
      String str="S.No  Service_Name\t\tQty\t Price\tDisc(Rs)\tAmount\n";
      rlen=str.length();
    ...
    try
    {
      String sql = "select  P_name, p_price ,p_qty ,p_disc ,p_amt  from cyber_INVOICETABLE where I_no='" + ino + "'";
      PreparedStatement pst = com.prepareStatement(sql);
      ResultSet rs = pst.executeQuery();
   ...
   doc.insertString(doc.getLength(), "Amount Chargeable(in words)\n", null);
       ...
       textPane.getStyledDocument().setCharacterAttributes(len, rlen, sas, false);
        ...
        doc.insertString(len=doc.getLength(),"for CYBER VALLEY\n\n\n", null);

        textPane.getStyledDocument().setCharacterAttributes(len, 16, sas, false);
    ...
    doc.insertString(len=doc.getLength(), "ONLINE FORM FILLING | PRINT  (COLOR / B&W) | XEROX  (COLOR / B&W) | SCAN\n", null);
        doc.insertString(doc.getLength(), "PHOTO PRINTING | SCAN e-MAIL | e-TICKETING(RAIL & FLIGHT) | e-AADHAAR PRINT\n",null);
        doc.insertString(doc.getLength(), "           SCHOOL PROJECTS | LAMINATION | IT RETURN FILLING\n", null);
  ...
  public void company(String ino)
  {
	   SimpleAttributeSet sas = new SimpleAttributeSet();
	    ...
	    und.addAttributes(styli);
	        ...
	        try
	        {
	        	String sql = "select to_char(date,'DD-MM-YYYY') , time from cyber_customers where invoice_no='" + ino + "'";
	          ...
	          int blen=0;
	          doc.insertString(doc.getLength(), "\t\t          ",null);
	          doc.insertString(blen=doc.getLength(),"INVOICE \n", styli);
	       ...
	       //   doc.insertString(doc.getLength(), "\t  Composition Taxable Person, not eligible to Collect Tax on Supplies\n", zyl);
	          ...
	          doc.insertString(blen=doc.getLength(), "CYBER VALLEY", style);
	          textPane.getStyledDocument().setCharacterAttributes(blen, 12, sas, false);
	          doc.insertString(doc.getLength(), "\n" + "Jay Prakash Nagar, Nala Road, Khagaria" +"\t\t",null);
	          ...
	          doc.insertString(blen=doc.getLength(), "Ph:",null); textPane.getStyledDocument().setCharacterAttributes(blen, 3, sas, false);
	          doc.insertString(doc.getLength(),"7808060629,7319945128" +"\t\t\t",null);
	          doc.insertString(blen=doc.getLength(),"Date:"+tempdate +"\n",null);textPane.getStyledDocument().setCharacterAttributes(blen, 5, sas, false);
	          
	          doc.insertString(blen=doc.getLength(),  "e-mail:" + "cybervalleykgg@gmail.com" +"\t\t\t",null);textPane.getStyledDocument().setCharacterAttributes(blen, 7, sas, false);
  ...
  public TasksRaw()
  {
    ...
    lblProductquantity_1.setFont(new Font("Segoe Print", Font.BOLD, 20));
    lblProductquantity_1.setBounds(530, 121, 45, 30);
    ...
    lblTotalAmount.setFont(new Font("Segoe Print", Font.BOLD, 20));
    lblTotalAmount.setBounds(615, 129, 100, 20);
    ...
    lblDiscount.setFont(new Font("Segoe Print", Font.BOLD, 20));
    lblDiscount.setBounds(429, 130, 60, 20);
    ...
    A.addKeyListener(new KeyAdapter()
    {
      public void keyPressed(KeyEvent e)
      {
        ...
        if (e.getKeyCode() == 10)
        {
          try
          {
            String query = "insert into cyber_invoicetable (p_name,p_price,p_qty,p_disc,p_amt , i_no) values (?,?,?,?,?,?)";
            
            PreparedStatement pst = con.prepareStatement(query);
            
  String combname=comboBox.getText();
 combname.toUpperCase();
            ...
            model.addRow(new String[] { combname, P.getText(), D.getText(), Q.getText(),A.getText() });
    ...
    A.setColumns(10);
    A.setBounds(591, 152, 105, 26);
    panel.add(A);
       
    JScrollPane scrollPane = new JScrollPane();
    scrollPane.setBounds(30, 182, 666, 315);
    ...
    table.setModel(new DefaultTableModel(
      ...
      new String[] {
      "          Service_Name", "          Rate", "          Discount","          Qty", "          Amount" })
      {
   ...
   /*comboBo = new JComboBox();
    comboBo.setFont(new Font("Tahoma", 0, 17));

    comboBo.getEditor().getEditorComponent().addKeyListener(new KeyAdapter()
    {
    ...
    JTextComponent editor = (JTextComponent)comboBo.getEditor().getEditorComponent();

    comboBo.setBounds(30, 102, 277, 26);
    panel.add(comboBo); */
    ...
    lblCategoryname.setFont(new Font("Segoe Print", Font.BOLD, 20));
    lblCategoryname.setBounds(30, 128, 248, 20);
      ...
      public void keyPressed(KeyEvent e)
      {
        ...
        if (e.getKeyCode() == 10)
        {
          ...
          if (invoice_no.getText().length() != 0)
          {
            try
            {
              String query = "INSERT INTO cyber_customers (invoice_no,date, time) VALUES (?,parsedatetime(?, 'dd-MM-yyyy'),parsedatetime(?, 'HH:mm'))";
          ...
          else
          {
            ...
            try
            {
              ...
              String query = "INSERT INTO cyber_customers (date, time) VALUES (parsedatetime(?, 'dd-MM-yyyy'),parsedatetime(?, 'HH:mm:ss'))";
            ...
            try
            {
              String sql = "select top 1 invoice_no  from cyber_customers order by date desc, time desc";
    ...
    textField.addKeyListener(new KeyAdapter() {
    	...
    	public void keyPressed(KeyEvent arg0) {
    		...
    		{
             try {   String query = "update cyber_customers set cust_name = ?  , cust_phone= ? ,address=? where invoice_no= '" + invoice_no.getText() + "' ";
    ...
    */
    ...
    table_1.addMouseListener(new MouseAdapter()
    {
      ...
      public void mouseClicked(MouseEvent e)
      {
        ...
        try
        {
          String sql = "select i_no ,p_name,p_price,p_disc,p_qty,p_amt from cyber_invoicetable where i_no='" + sid + "'";
    ...
    btnLoadDetaila.addActionListener(new ActionListener()
    {
      ...
      {
        try {
          String sql = "select INVOICe_no,to_char(date,'DD-MM-YYYY'),time,cUST_name , CUST_phone, address, total_items,grand_total from cyber_customers order by date desc, time desc";
        ...
        table_3.setModel(new DefaultTableModel(
          ...
          new String[] {
        		  "S_Name", "Rate", "Discount","Qty", "Amount" }));
      ...
      public void keyPressed(KeyEvent e)
      {
        if (e.getKeyCode() == 10)
        {
          try
          {
            ...
            String sql = "select INVOICe_no,to_char(date,'DD-MM-YYYY'),time,cUST_name , CUST_phone,total_items,grand_total from  cyber_customers  where INvoice_no='" + i + "'  order by date desc,time desc";
    ...
    button.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent arg0) {
        ...
        try
        {
          String sql = "\r\nselect INVOICe_no,to_char(date,'DD-MM-YYYY'),time,cUST_name , CUST_phone,total_items,grand_total  from  cyber_customers   where date=parsedatetime(?, 'dd-MM-yyyy') order by date asc,time desc";
    ...
    button_2.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent e)
      {
        ...
        try
        {
          String sql = "select INVOICe_no,TO_CHAR(date,'DD-MM-YYYY'),time,cUST_name , CUST_phone,total_items,grand_total  from  cyber_customers where   date  between parsedatetime(?, 'dd-MM-yyyy') and parsedatetime(?, 'dd-MM-yyyy') order by date desc,time desc";
          PreparedStatement pst = com.prepareStatement(sql);
    ...
    lblDeleteInvoice.setBounds(663, 486, 113, 27);
      ...
      public void keyPressed(KeyEvent e)
      {
        if (e.getKeyCode() == 10)
        {
          ...
          if (action == 0)
          {
            ...
            try
            {
              String query = "delete from cyber_customers where invoice_no=?";
            ...
            try
            {
              String query = "delete from cyber_invoicetable where i_no=?";
            ...
            try
            {
              String sql = "select INVOICe_no,to_char(date,'DD-MM-YYYY'),time,cUST_name ,CUST_phone,total_items,grand_total from  cyber_customers   order by date desc,time desc";
    ...
    textField_3.setBounds(766, 491, 94, 20);
    ...
    lblPrintInvoice.setBounds(10, 486, 113, 27);
    ...
    textField_13.setBounds(113, 491, 94, 20);
    ...
    btnDeleteAllItems.addActionListener(new ActionListener()
    {
      public void actionPerformed(ActionEvent arg0)
      {
        ...
        if (action == 0)
        {
          try
          {
            String sql = " DELETE FROM  cyber_customers";
          ...
          try
          {
            String sql = " DELETE FROM cyber_invoicetable ";
    ...
    btnPrintInvoice.addActionListener(new ActionListener() {
    	public void actionPerformed(ActionEvent arg0) {
              ...
              try
              {
                ...
                String query = " update cyber_customers set grand_total = '" + gt + "' , total_items='" + ti + "' where invoice_no='" + in + "'";
    ...
    btnPrintInvoice.setBounds(250, 508, 119, 32);
    	...
    	public void actionPerformed(ActionEvent arg0) {
            ...
            if (action == 0)
            {
              ...
              try
              {
                ...
                String query = "Delete from cyber_invoicetable where i_no='" + invoice_no.getText() + "' and P_name='" + name + "'";
    ...
    btnCancelInvoice.setBounds(580, 508, 119, 32);
    ...
    comboBox.setHorizontalAlignment(SwingConstants.LEFT);
    comboBox.setFont(new Font("Tahoma", Font.PLAIN, 18));
    comboBox.setColumns(10);
    comboBox.setBounds(30, 152, 277, 26);
    panel.add(comboBox);
    ...
    btnSaveInvoice.setFont(new Font("Tahoma", Font.PLAIN, 12));
    Image saveimg = new ImageIcon(getClass().getResource("/save.png")).getImage();
    btnSaveInvoice.setIcon(new ImageIcon(saveimg));
  
    btnSaveInvoice.setBorder(new BevelBorder(BevelBorder.RAISED, Color.WHITE, Color.WHITE, Color.BLACK, Color.BLACK));
    btnSaveInvoice.setBackground(new Color(70, 130, 150));
    btnSaveInvoice.setBounds(390, 508, 119, 32);
    panel.add(btnSaveInvoice);
    
    JLabel lblNewLabel = new JLabel("(Rs)");
    lblNewLabel.setFont(new Font("Segoe Print", Font.BOLD, 15));
    lblNewLabel.setForeground(Color.WHITE);
    lblNewLabel.setBounds(482, 125, 29, 30);
